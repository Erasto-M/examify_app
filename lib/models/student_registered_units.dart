...
class StudentsRegisteredUnitsModel {
  ...
  factory StudentsRegisteredUnitsModel.fromMap(Map<String, dynamic> map) {
    return StudentsRegisteredUnitsModel(
      ...
      assignMent1Marks: map['assignMent1Marks'] != null ? map["assignMent1Marks"] ?? 0 as int : null,
      assignMent2Marks: map['assignMent2Marks'] != null ? map["assignMent2Marks"] ?? 0 as int : null,
      assignMent1OutOff: map['assignMent1OutOff'] != null ? map["assignMent1OutOff"] ?? 0 as int : null,
      assignMent2OutOff: map['assignMent2OutOff'] != null ? map["assignMent2OutOff"] ?? 0 as int : null,
      cat1Marks1OutOff: map['cat1Marks1OutOff'] != null ? map["cat1Marks1OutOff"] ?? 0 as int : null,
      cat2MarksOutOff: map['cat2MarksOutOff'] != null ? map["cat2MarksOutOff"] ?? 0 as int : null,
      examMarksOutOff: map['examMarksOutOff'] != null ? map["examMarksOutOff"] ?? 0 as int : null,
      ...
      isUnitApproved: map['isUnitApproved'] != null ? map["isUnitApproved"] ?? false as bool : null,
