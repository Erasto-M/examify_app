...
class StudentsRegisteredUnitsModel {
  ...
  factory StudentsRegisteredUnitsModel.fromMap(Map<String, dynamic> map) {
    return StudentsRegisteredUnitsModel(
      ...
      unitDepartment: map['unitDepartment'] != null ? map['unitDepartment'] as String : null,
      ...
      studentRegNo: map['studentRegNo'] != null ? map['studentRegNo'] as String : null,
      studentUid: map['studentUid'] != null ? map['studentUid'] as String : null,
      studentEmail: map['studentEmail'] != null ? map['studentEmail'] as String : null,
      studentPhoneNumber: map['studentPhoneNumber'] != null ? map['studentPhoneNumber'] as String : null,
      studentGender: map['studentGender'] != null ? map['studentGender'] as String : null,
      assignMent1Marks: map['assignMent1Marks'] != null ? map['assignMent1Marks'] as int : null,
      assignMent2Marks: map['assignMent2Marks'] != null ? map['assignMent2Marks'] as int : null,
      assignMent1OutOff: map['assignMent1OutOff'] != null ? map['assignMent1OutOff'] as int : null,
      assignMent2OutOff: map['assignMent2OutOff'] != null ? map['assignMent2OutOff'] as int : null,
      cat1Marks1OutOff: map['cat1Marks1OutOff'] != null ? map['cat1Marks1OutOff'] as int : null,
      cat2MarksOutOff: map['cat2MarksOutOff'] != null ? map['cat2MarksOutOff'] as int : null,
      examMarksOutOff: map['examMarksOutOff'] != null ? map['examMarksOutOff'] as int : null,
      cat1Marks: map['cat1Marks'] != null ? map['cat1Marks'] as int : null,
      cat2Marks: map['cat2Marks'] != null ? map['cat2Marks'] as int : null,
      examMarks: map['examMarks'] != null ? map['examMarks'] as int : null,
      totalMarks: map['totalMarks'] != null ? map['totalMarks'] as int : null,
      grade: map['grade'] != null ? map['grade'] as String : null,
      appliedSpecialExam: map['appliedSpecialExam'] != null ? map['appliedSpecialExam'] as bool : null,
      missingMarksMessage: map['missingMarksMessage'] != null ? map['missingMarksMessage'] as String : null,
      isUnitApproved: map['isUnitApproved'] != null ? map['isUnitApproved'] as bool : null,
