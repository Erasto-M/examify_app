...
class StudentRegisterUnitSheet
  ...
  Widget builder(
    ...
    return ChangeNotifierProvider(
        create: (context) => SelectedUnitsNotifier(),
        child: Consumer<SelectedUnitsNotifier>(
          builder: (context, selectedUnitsNotifier, child) {
            return Container(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: Column(
                      children: [
                            ...
                            Container(
                              ...
                              child: DropdownButton(
                                  ...
                                  items: viewModel.semesterStages
                                      ...
                                      .toList(),
                                  onChanged: (newValue) {
                                    viewModel.setSelectedSemesterStage(
                                        newValue.toString());
                                  }),
                            )
                          ],
                        ...
                        const Center(
                          child: Text(
                              "Choose Atleast 5 Units  for the current semester",
                              style: TextStyle(
                                fontSize: 15,
                              )),
                        ),
                                ...
                                child: Container(
                                  ...
                                  child: CheckboxListTile(
                                    ...
                                    value: selectedUnitsNotifier
                                        .isUnitsSelected(unit.unitId!),
                                    onChanged: (value) {
                                      selectedUnitsNotifier.updateUnitSelection(
                                          value!, unit);
                  ...
                  Center(
                    child: InkWell(
                      onTap: () {
                        viewModel.sendUnitsToFirebase(context);
