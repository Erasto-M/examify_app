            ...
            child: Column(
              ...
              children: [
                Container(
                    ...
                    verticalSpaceSmall,
                  const  Text("Courses Lectured", style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                    ),),
                    verticalSpaceMedium,
                                    ...
                                    title: Row(
                                      children: [
                                       ...
                                       IconButton(
                                          ...
                                          icon:  viewModel.isContainerHidden(unit.unitId!) == true? const Icon(Icons.arrow_drop_down_outlined) :  const  Icon(Icons.arrow_drop_up_outlined),
                                        ),
                                      ],
                                    ),
                                    subtitle: viewModel.isContainerHidden(unit.unitId!) == true ? const SizedBox():
                                     Center(
                                      child: Container(
                                        height: 50,
